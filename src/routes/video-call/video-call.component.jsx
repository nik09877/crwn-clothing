...
import {
  roomUrlFromPageUrl,
  pageUrlFromRoomUrl,
} from '../../utils/video-call/video-call-utils';

import HomeScreen from '../../components/video-call-HomeScreen/HomeScreen';
import Call from '../../components/video-call-Call/Call';
import Tray from '../../components/video-call-Tray/Tray';
import HairCheck from '../../components/video-call-HairCheck/HairCheck';
...
const VideoCall = () => {
  ...
  return <div className='video-call'>{renderApp()}</div>;
};
